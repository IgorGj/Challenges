...
const ShopDetail: NextPage<Props> = ({ productData, featuredProductsData }) => {
  const { id, title, price, gender, img, description } = productData;
  return (
    <>
      <Head>
      ...
      <RelatedProducts featuredProductsData={featuredProductsData} />
    </>
  );
};
